...
This week in class we explored different codes of conduct. A CoC isn't just another markdown file you can add to a repository. It allows you to define and shape how a project's community interacts. And this is crucial to an open source project's success, as I will touch on again below. Click [here](https://ossd-s26.github.io/deweesevs-weekly/CoC-Activity/) to view the blog post for Week 2's Code of Conduct Activity.
...
Because a project's contributors can span multiple time zones, it is important to be flexible with holding meetings. Try and holdthem at different times, that way no one in particular must take on the burden of the time difference. Also ensure the agenda is flexible. A fixed meeting agenda can limit creativity.
